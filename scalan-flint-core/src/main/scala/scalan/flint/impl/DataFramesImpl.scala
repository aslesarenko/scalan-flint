...
trait DataFramesExp extends ScalanExp with DataFramesDsl {
  ...
  object ShardedDFCompanionMethods {
    object create {
      def unapply(d: Def[_]): Option[(Rep[Int], Rep[Int => TableDF[T]], Rep[T => Int]) forSome {type T}] = d match {
        case MethodCall(receiver, method, Seq(nShards, createShard, distrib, _*), _) if receiver.elem == ShardedDFCompanionElem && method.getName == "create" =>
          Some((nShards, createShard, distrib)).asInstanceOf[Option[(Rep[Int], Rep[Int => TableDF[T]], Rep[T => Int]) forSome {type T}]]
        case _ => None
      }
      def unapply(exp: Exp[_]): Option[(Rep[Int], Rep[Int => TableDF[T]], Rep[T => Int]) forSome {type T}] = exp match {
        case Def(d) => unapply(d)
        case _ => None
      }
    }
...
object DataFrames_Module extends scalan.ModuleInfo {
  val dump = ""
}
}
